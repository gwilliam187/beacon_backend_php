    ...
    <!-- END MINI-PROFILE -->
      ...
      <ul>
        ...
        <li class="side-course">
          ...
          <ul class="sub-menu">
            <li><a href="theme_coporate.html">Add Course</a></li>
            <li><a href="theme_simple.html">View Courses</a></li>
          </ul>
        </li>
        <li class="side-student">
          ...
          <ul class="sub-menu">
            <li><a href="theme_coporate.html">Add Student</a></li>
            <li><a href="theme_simple.html">View Students</a></li>
          </ul>
        </li>
        <li class="side-major">
          <a href="email.html"><i class="material-icons">school</i> <span class="title">Majors</span> <span class="arrow"></span> </a>
          <ul class="sub-menu">
            <li><a href="theme_coporate.html">Add Major</a></li>
            <li><a href="theme_simple.html">View Majors</a></li>
          </ul>
        </li>
        <li class="side-room">
