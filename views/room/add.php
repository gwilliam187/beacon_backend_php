    ...
    <?php echo $sidebar; ?>
    	...
    	<div class="content">
				...
				<div class="page-title"> <i class="icon-custom-left"></i>
					<h3>Room - <span class="semi-bold">Add</span></h3>
				</div>
				<div class="row" >
          <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-8" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" name="beacon" class="form-control">
                        </div>
                      </div>
                    </div>
  								</div>
...
<script>
  $(document).ready(function() {
    $("#pageForm").submit(function(e) {
      ...
      $.post("/beacon_backend/api/room/create.php", data, function(data, status) {
        if(status == "success") {
          $("#pageForm").prepend(
